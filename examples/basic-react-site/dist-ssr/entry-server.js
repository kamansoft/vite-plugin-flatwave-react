...
function SimplePage({ content }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: content.frontmatter.title }),
    content.frontmatter.description ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: String(content.frontmatter.description) }) : null
  ] });
}
function ProgramPage({ content }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: content.frontmatter.title }),
    content.frontmatter.description ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: String(content.frontmatter.description) }) : null,
    content.frontmatter.date ? /* @__PURE__ */ jsxRuntimeExports.jsx("time", { dateTime: String(content.frontmatter.date), children: String(content.frontmatter.date) }) : null
  ] });
}
...
async function render(url, pageContext) {
  ...
  const App = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: locale, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("head", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: route.metadata.title }),
      route.metadata.description && /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "description", content: route.metadata.description }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("link", { rel: "canonical", href: route.metadata.canonical ?? route.path }),
      renderHtmlHead(route)
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("body", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "root", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Component, { content }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { dangerouslySetInnerHTML: { __html: bodyHtml } })
    ] }) })
  ] });
  return server_nodeExports.renderToString(/* @__PURE__ */ jsxRuntimeExports.jsx(App, {}));
}
function renderHtmlHead(route) {
